...
export default function Home(props) {
  ...
  <div>
    ...
    <div className='players'>
      <PlayerNameInput imagePath='/images/Player1.png' inputPlaceholder='Name of player 1' onChange={(e) => setPlayer1Name(e.target.value)} />
      <PlayerNameInput imagePath='/images/Player2.png' inputPlaceholder='Name fo player 2' onChange={(e) => setPlayer2Name(e.target.value)} />
    </div>
    <div className='play-button-contaner'>
      <button className='play-button' onClick={(e) => handleClick(e)}>Let's Play</button>
    </div>
  </div>
  )
}